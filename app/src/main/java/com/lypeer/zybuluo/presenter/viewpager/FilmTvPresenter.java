...
import com.lypeer.zybuluo.model.remote.viewpager.FilmTvModel;
...
public class FilmTvPresenter extends BasePresenter<FilmTvFragment , FilmTvModel> {
    @Override
    protected FilmTvModel createModel() {
        return new FilmTvModel(this);
    }
