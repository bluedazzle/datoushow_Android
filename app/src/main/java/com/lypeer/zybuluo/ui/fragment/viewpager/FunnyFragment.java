...
public class FunnyFragment extends BaseFragment<FunnyPresenter> implements OnRefreshListener, OnLoadMoreListener {
    ...
    protected int getResId() {
        return R.layout.fragment_funnny;
    }
