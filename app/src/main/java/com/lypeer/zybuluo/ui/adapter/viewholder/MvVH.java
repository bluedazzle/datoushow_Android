...
public class MvVH extends BaseViewHolder<VideoResponse.BodyBean.VideoListBean> {
    ...
    public MvVH(Context context, ViewGroup root) {
        super(context, root, R.layout.item_mv);
    }
