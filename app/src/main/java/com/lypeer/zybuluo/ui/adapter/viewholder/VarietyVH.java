...
public class VarietyVH extends BaseViewHolder<VideoResponse.BodyBean.VideoListBean> {
    ...
    public VarietyVH(Context context, ViewGroup root) {
        super(context, root, R.layout.item_variety);
    }
