...
public class HotVH extends BaseViewHolder<VideoResponse.BodyBean.VideoListBean> {
    ...
    public HotVH(Context context, ViewGroup root) {
        super(context, root, R.layout.item_hot);
    }
