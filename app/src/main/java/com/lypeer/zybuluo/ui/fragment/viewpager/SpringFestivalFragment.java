...
import com.lypeer.zybuluo.ui.adapter.SpringFestivalAdapter;
...
public class SpringFestivalFragment extends BaseFragment<SpringFestivalPresenter> implements OnRefreshListener, OnLoadMoreListener {
    ...
    private SpringFestivalAdapter mAdapter;
    ...
    protected int getResId() {
        return R.layout.fragment_spring_festival;
    }
    ...
    private void initList() {
        mAdapter = new SpringFestivalAdapter();
