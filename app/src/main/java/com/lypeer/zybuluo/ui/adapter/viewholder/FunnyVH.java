...
public class FunnyVH extends BaseViewHolder<VideoResponse.BodyBean.VideoListBean> {
    ...
    public FunnyVH(Context context, ViewGroup root) {
        super(context, root, R.layout.item_funny);
    }
