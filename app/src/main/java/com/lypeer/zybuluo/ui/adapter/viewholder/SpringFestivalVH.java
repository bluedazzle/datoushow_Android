...
public class SpringFestivalVH extends BaseViewHolder<VideoResponse.BodyBean.VideoListBean> {
    ...
    public SpringFestivalVH(Context context, ViewGroup root) {
        super(context, root, R.layout.item_spring_festival);
    }
