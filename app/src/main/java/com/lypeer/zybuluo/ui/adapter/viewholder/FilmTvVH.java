...
public class FilmTvVH extends BaseViewHolder<VideoResponse.BodyBean.VideoListBean> {
    ...
    public FilmTvVH(Context context, ViewGroup root) {
        super(context, root, R.layout.item_film_tv);
    }
