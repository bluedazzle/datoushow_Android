...
public class Guide2Fragment extends BaseCustomFragment {
    ...
    protected void initView(@Nullable Bundle savedInstanceState) {
        String path = FileUtil.getStorageDir() + "/video_guide_2.mp4";
    ...
    public void onEvent(EmptyEvent event) {
        ...
        if (event instanceof PageChangeEvent) {
            ...
            if (pageChangeEvent.getCurrentFragment() == Constants.GuideFragmentId.GUIDE_2) {
