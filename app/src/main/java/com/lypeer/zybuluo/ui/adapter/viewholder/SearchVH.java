...
public class SearchVH extends BaseViewHolder<VideoResponse.BodyBean.VideoListBean> {
    ...
    public SearchVH(Context context, ViewGroup root) {
        super(context, root, R.layout.item_search);
    }
